...
Para la otra implicación, supongamos que $v_F(0)=w_F(0)$ para todo par HM. Consideremos $q\in \pt A$ y $p\in A$ tales que $q\leq p$. Para el par HM ($F_p, \uparrow p$) se cumple que
\[
