...
Antes de reponder esto, necesitamos algunos resultados auxiliares. Si tomamos $p\in \pt A$ y el par HM $(F_p, \uparrow p)$, se cumple que para 
\[
...
Para la otra impliación, supongamos que $v_F=w_F$ para todo par HM y veamos que $A$ es fuertemente apilado y $T_1$.\\

Primero, consideremos $p\in \pt A$ y $a\in A$ tales que $p\leq a$. Como $v_F=w_F$, se cumple que $v_F(0)=w_F(0)$ para todo par HM.

De aquí que $p=w_p(0)=w_{F_p}(0)\leq v_{F_p}(q)=q$. Por lo tanto, $p=q$ y todo punto es máximo, es decir, $A$ es $T_1$.\\
...
\textbf{requiero corregir la demostración anterior y la siguiente}
...
Para la otra implicación, supongamos que $v_F(0)=w_F(0)$ para todo par HM y veamos que $A$ es $T_1$ y apilado.\\

Primero, consideremos $p\in \pt A$ y $a\in A$ tales que $p\leq a$.
