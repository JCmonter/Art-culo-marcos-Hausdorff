...
\section{Compact quotients induced by open filters}
...
is also bijective. Thus, if $F\in A^\wedge$, then $(F, v_F(0)), (F, w_F(0))\in \pt(VA)$ and so
\[
...
Note that, item 3) holds if $A$ is spatial, then  De esta manera, podría ocurrir que los resultados en los cuales pedimos que $A$ sea espacial,
basta con que $\mathcal{V}(a)\neq \emptyset$ con $a\in A$.\\

La siguiente es una posible consecuencia del caso espacial
\[
